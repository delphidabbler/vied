...
"Apps and Features" applet (a.k.a "Programs and Features" or "Add/Remove
Programs"). Locate DelphiDabbler Version Information Editor in the list of
installed programs and click the remove button. The uninstaller will now run,
asking you to confirm that you want to uninstall.
...
https://delphidabbler.com/software/vied for program updates.
...
If you find any bugs please report them using the Version Information Editor
Issues page at https://github.com/delphidabbler/vied/issues.

You can use the same page to make suggestions or request new features.


8) About DelphiDabbler
----------------------

DelphiDabbler is Peter Johnson - a hobbyist Delphi programmer living in
Ceredigion, Wales, UK.

The DelphiDabbler website is at https://delphidabbler.com/ and contains all
Peter's open source programs, Delphi library code, programming articles, hints
and tips and other resources.
